...
- *Folder-Based Galleries*: Dynamic routing from src/gallery/photos/** structure
...
- `/src/gallery/photos/red-carpet/tiff/` - Sample gallery structure
...
3. Optionally run: `node scripts/generate-tags-json.js ./src/gallery/photos/folder`
